...
public class OrderDiagnosisLookupDAO implements IOrderDiagnosisLookupDAO, DAOInterface, IStructureCheckable
{
    ...
    public Boolean Insert(Serializable obj)
    {
        ...
        {
            Logger.getLogger(OrderDiagnosisLookupDAO.class.getName()).log(Level.SEVERE, null, ex);
            return null;
        }
    }
    ...
    public String structureCheck() {
        String query = "SELECT `orderDiagnosisLookup`.`idDiagnosisLookup`,\n"
                ...
                + "    `orderDiagnosisLookup`.`advancedOrder`\n"
                + "FROM `cssweb`.`orderDiagnosisLookup` LIMIT 1";
