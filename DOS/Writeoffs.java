...
@NamedQueries({
    @NamedQuery(name = "Writeoffs.findAll", query = "SELECT w FROM Writeoffs w")})
public class Writeoffs implements Serializable {
    ...
    public Writeoffs(Integer idtransactions) {
        this.idtransactions = idtransactions;
    }

    public Writeoffs(Integer idtransactions, BigDecimal amount, Date entered) {
        this.idtransactions = idtransactions;
        this.amount = amount;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Writeoffs)) {
            return false;
        }
        Writeoffs other = (Writeoffs) object;
    ...
    public String toString() {
        return "DOS.Writeoffs[ idtransactions=" + idtransactions + " ]";
    }
