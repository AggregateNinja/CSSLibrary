...
/**
 * @date:   Oct 23, 2014  11:34:30 AM
 * @author: Ryan Piper ryan@csslis.com
 * 
 * @project: CSSLibrary
 * @file name: InsuranceXref.java  (UTF-8)
 *
 * @Description: 
 *
 */
...
@Entity
@Table(name = "insuranceXref")
@NamedQueries({
    @NamedQuery(name = "InsuranceXref.findAll", query = "SELECT i FROM InsuranceXref i")})
public class InsuranceXref implements Serializable {
    ...
    public InsuranceXref() {
    }

    public InsuranceXref(Integer id) {
        this.id = id;
    }

    public InsuranceXref(Integer id, String transformedIn, String transformedOut, Date created, boolean active) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof InsuranceXref)) {
            return false;
        }
        InsuranceXref other = (InsuranceXref) object;
    ...
    public String toString() {
        return "DOS.InsuranceXref[ id=" + id + " ]";
    }
