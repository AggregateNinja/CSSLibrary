...
public class PrescriptionDAO implements IPrescriptionDAO, DAOInterface, IStructureCheckable
{
    ...
    public Boolean Insert(Serializable obj)
    {
        try
        {
            return InsertPrescription((Prescriptions)obj);
        }
    ...
    public Boolean Update(Serializable obj)
    {
        try
        {
            return UpdatePrescription((Prescriptions)obj);
        }
        catch (SQLException ex)
        {
            Logger.getLogger(PrescriptionDAO.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public Boolean Delete(Serializable obj)
    {
        ...
        try {
            Prescriptions prescription = (Prescriptions)obj;
    ...
    public String structureCheck() {
        String query = "SELECT `prescriptions`.`idprescriptions`,\n"
                ...
                + "FROM `css`.`prescriptions` LIMIT 1";
